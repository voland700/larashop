                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="h1" name="h1" value="" placeholder="Заголовок страницы товара...">
                        </div>

                        <div class="form-group">
                            <label for="meta_title">META Title</label>
                            <input type="text" class="form-control" id="meta_title" name="meta_title" value="" placeholder="CEO заголовок страницы товара...">
                        </div>

                        <div class="form-group">
                            <label for="meta_description">META Description</label>
                            <textarea class="form-control" id="meta_description" name="meta_description" rows="3" placeholder="CEO описание страницы товара..."></textarea>
                        </div>
                         ...
                         <div class="form-group row">
                            <label class="col-sm-6 col-form-label text-lg-right">{{$attr->name}}</label>
                                <div class="col-sm-6 d-flex align-items-center">
                                    ...
                                    <input type="text" name="properties[{{ $attr->id }}][value]" class="form-control" placeholder="Значение...">
                                </div>
